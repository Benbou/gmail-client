...
add_env "FRONTEND_URL" "https://gmail-client-xi-lemon.vercel.app"
...
echo -e "${GREEN}║                                                            ║${NC}"
echo -e "${GREEN}║  Ton app : https://gmail-client-xi-lemon.vercel.app       ║${NC}"
echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
echo "3. Redirect URL: https://gmail-client-xi-lemon.vercel.app/**"
echo ""
